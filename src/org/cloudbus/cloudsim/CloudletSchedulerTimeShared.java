...
public class CloudletSchedulerTimeShared extends CloudletScheduler {
	...
	public double cloudletSubmit(Cloudlet cloudlet, double fileTransferTime) {
		//System.out.println("Time shared schudular!");
		...
		//System.out.println("cloudlet.getCloudletLength()"+cloudlet.getCloudletLength());
		//System.out.println("getCapacity(getCurrentMipsShare())"+getCapacity(getCurrentMipsShare()));
