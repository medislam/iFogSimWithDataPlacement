...
public class Host {
	...
	public boolean vmCreate(Vm vm) {
		//System.out.println("Datacenter Name:"+getDatacenter().getName()+"     getStorage="+getStorage()+"   Module Nmae:"+vm.getUid()+"    Module Storage="+vm.getSize());
		...
		getVmList().add(vm);
		vm.setHost(this);
		//System.out.println("Module : "+vm.getUid()+"   is well created in FogDevice : "+getDatacenter().getName());
		return true;
	}
